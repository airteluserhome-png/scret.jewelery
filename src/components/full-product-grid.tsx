    ...
    return (
        <div className="px-4 md:px-8 lg:px-10 py-8 md:py-12">
            <div className="mb-8 md:mb-12">
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-brutalist text-hot-pink brutalist-border-b pb-3 md:pb-4 tracking-[0.05em] leading-none uppercase hero-3d-text">
                    The Collection
                </h2>
            </div>
