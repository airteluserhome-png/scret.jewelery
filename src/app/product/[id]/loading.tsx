...
export default function Loading() {
    // Noise texture SVG (matching global layout)
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#F9F9F9]">
            ...
            <div className="relative z-10 flex flex-col items-center">
                ...
                {/* Progress Line */}
                <div className="w-full h-[1px] bg-black/10 mt-4 overflow-hidden">
                    <motion.div
